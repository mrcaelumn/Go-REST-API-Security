...
import (
	...
	"github.com/mrcaelumn/Go-REST-API-Security/api/client"
	"github.com/mrcaelumn/Go-REST-API-Security/api/tool/cli"
...
func main() {
	...
	app := &cobra.Command{
		Use:   "go-rest-security-cli",
		Short: `CLI client for the go-rest-security service`,
	}
	...
	c.UserAgent = "go-rest-security-cli/1.0"
