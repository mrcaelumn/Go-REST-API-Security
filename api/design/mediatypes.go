...
var CustomeErrorMedia = MediaType("application/vnd.gorestsecurity-error+json", func() {
...
var VersionMedia = MediaType("application/vnd.gorestsecurity-version+json", func() {
	ContentType("application/json")
